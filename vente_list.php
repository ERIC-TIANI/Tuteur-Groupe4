...
// Requête pour récupérer les biens à vendre avec les noms de l'utilisateur et de la catégorie
$sql = "SELECT 
            b.id_property, 
            b.titre, 
            b.ville, 
...
<body>
    ...
    <div class="main-content">
        <header>
            <h1>Biens immobiliers à vendre</h1>
            <a href="vente_create.php" class="btn-ajout">+ Ajouter un bien</a>
        </header>
            ...
            <tbody>
                <?php foreach ($biens as $bien): ?>
                    <tr>
                        ...
                        <td>
                            <a href="vente_edit.php?id=<?= $bien['id_property'] ?>" class="btn-modif">Modifier</a>
                            <a href="vente_delete.php?id=<?= $bien['id_property'] ?>" class="btn-suppr" onclick="return confirm('Supprimer ce bien ?')">Supprimer</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
                <?php if (empty($biens)): ?>
                    <tr><td colspan="10">Aucun bien à vendre trouvé.</td></tr>
                <?php endif; ?>
            </tbody>
        </table>
    </div>
